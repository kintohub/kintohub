...
9. Add the **key** `HASURA_GRAPHQL_ENABLE_CONSOLE` and enter the value `true`
10. Click **Deploy** at the top right

<img alt="Hasura Environment Variables" src={useBaseUrl('img/fullstack-example/hasura-env-vars.png')} />
...
<img alt="Hasura Console" src={useBaseUrl('img/fullstack-example/hasura-console.png')} />
...
<img alt="React Webapp Environment Variables" src={useBaseUrl('img/fullstack-example/react-webapp-env-vars.png')} />
