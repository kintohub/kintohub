...
KintoHub has as command line interface (CLI) which can be used to debug and interact with your services.a
...
<Tabs
  ...
  <TabItem value="windows">
    ...
    iwr -useb https://cli.kinto.io/win-install | iex
  </TabItem>
  <TabItem value="linux">
    You can install kinto-cli with the following command within your terminal:
...
Lists all environments that the `.git` repository has ebeen deployed to.
...
This command will port-forward all of your remote services from the chosen environment to your local machine.
...
INFO:     > Forwarding: localhost:5360 => elixirexamples:80
